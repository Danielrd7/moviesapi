package com.danielrd7.moviesApi.service;
...
public class MoviesService {
     ...
     * {@code null}
     * @throws ItemNotFoundExeption when the movie id does not exist
     * @throws ItemIdMismatchException when path id and payload id do not match
     * @throws DuplicatedItemExeption when another movie already uses the same
